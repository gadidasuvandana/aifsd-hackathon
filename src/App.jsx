...
${text}`
      ...
      // Clean up the response to ensure it's valid PlantUML
      let generatedPuml = data.response.trim()
      
      // Remove any @plantuml tags if they exist
      generatedPuml = generatedPuml.replace(/@plantuml/g, '@startuml')
      
      // Ensure the response starts with @startuml and ends with @enduml
